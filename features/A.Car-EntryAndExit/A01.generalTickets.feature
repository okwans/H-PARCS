...
Feature: 차량_입출차_동작_확인-일반차량
  ...
  @A01_01_차량_입출차_동작_확인-일반차량
  Scenario Outline: 차량 입출차 동작 확인(일반차량)
    ...
    Then A01.01 - 해당 차량이 출차시 주차시간이 회차시간 "<freeTime>" 미만일 경우 요금 정산은 이뤄지지 않고 회차시간 이상일 경우 over되는 시간 만큼 요금 "<bill>"원을 결재해야 한다.
    Examples: API_Data
    | plateNumber | entryTime | freeTime | bill  |
    | 10하9088    | 25        | 30       | 0     |
    | 20하9099    | 5         | 30       | 0     |
    | 30하1010    | 19        | 30       | 0     |
    | 40하8250    | 35        | 30       | 500   |
    ...
    | 60하7174    | 29        | 30       | 0     |
    | 70하1111    | 180       | 30       | 500   |
    | 80하8888    | 1440      | 30       | 20000 |
    | 90하0001    | 100       | 30       | 0     |
    | 10하9900    | 1800      | 30       | 38000 |

  @A01_02_차량_입출차_동작_확인-일반차량
  Scenario Outline: 차량 입출차 동작 확인(일반차량) - 사전정산 완료 후, 출차 동작 확인
